...
var add = __webpack_require__(10).default
module.exports.__inject__ = function (context) {
  add("21669fc2", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_1030309f_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(204);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_1030309f_prod_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_1030309f_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_1030309f_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_1030309f_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "#news-container{margin:120px}.news-container-heading{background:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") 0 100% no-repeat;border-top:2px solid #efefef;margin-top:150px;padding:20px 0}.date{color:#999}.latest-news{margin-bottom:80px}.latest-news-item{background:var(--primary-color);height:530px;transition:.5s ease}.latest-news-item:hover{cursor:pointer;opacity:.8}.heading-img p{margin:0}.news-heading-image{position:relative}.news-heading-image img{max-height:400px;width:100%}.news-heading{color:#fff;padding:20px}.overlay-news-heading{background:#28788c;background:linear-gradient(0deg,#28788c,#208ba4 15%,hsla(0,0%,100%,0) 40%);bottom:0;position:absolute;top:0;width:100%}.news-container-main-item{margin-bottom:60px}.news-container-main-item:hover{cursor:pointer}.news-container-main-img img{width:100%}.news-desc{--line-clamp:3;-webkit-line-clamp:3;height:100%;overflow:hidden;word-break:break-word}.most-viewed{margin-bottom:60px}.most-viewed-heading{background:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") 0 100% no-repeat;font-size:22px;font-weight:700;line-height:26px;margin-bottom:20px;padding:10px 0 20px}@media screen and (max-width:739px){.latest-news-item{min-height:300px}}@media (max-width:1024px){#news-container{margin:15px}.news-container-heading{margin-top:90px}.latest-news-first-child{margin-bottom:20px}.news-title h3{margin-top:0}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index/hall-of-fame/index.vue?vue&type=template&id=1030309f&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    ...
    }, [data.titleImage ? _c('div', {
      staticClass: "heading-img",
      domProps: {
        "innerHTML": _vm._s(data.titleImage)
      }
    }) : _c('img', {
      attrs: {
    ...
    attrs: {
      "hide-on-single-page": _vm.hidePage,
  ...
  }), 0)])])], 1)], 1), _vm._ssrNode(" "), _c('PartnersCarousel')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/index/hall-of-fame/index.vue?vue&type=template&id=1030309f&
