...
var render = function render() {
  ...
  return _c('div', [_vm._ssrNode("<div id=\"storytelling-course-banner\" class=\"banner\"><div class=\"banner-text\"><div class=\"banner-text-content\"><p>DÀNH CHO ĐỘ TUỔI: 6-8 TUỔI</p> <h1>KHÓA HỌC LUYỆN THI TOEIC</h1> <h2>TOEIC COURSE</h2> <h4 style=\"margin:5px 0\">THỜI GIAN ĐÀO TẠO: 3 THÁNG</h4></div> <div class=\"banner-border-bottom\"></div></div></div> "), _vm._ssrNode("<div class=\"section section1\">", "</div>", [_c('el-row', {
    ...
    staticClass: "section1-intro-text"
  }, [_c('p', [_vm._v("Khung chương trình giản lược, tập trung các kiến thức trọng điểm")])])])])], 1)], 1), _vm._ssrNode(" <div class=\"section section2-toeic\"><div class=\"section2-intro\"><h2 style=\"margin-top: 0; text-align: center\">\n              Giới thiệu về khóa học\n          </h2> <p>Tại Uni, đội ngũ giảng viên hội tụ cả ba yếu tố tâm huyết - trí tuệ và phong cách để có cách dạy vừa cuốn hút, vừa dễ hiểu, giúp học viên chinh phục mục tiêu của mình trong thời gian ngắn nhất</p> <div class=\"section2-toeic-content\"><div class=\"section-content-row-fl section1-intro-content\"><div class=\"section1-intro-img\"><img" + _vm._ssrAttr("src", __webpack_require__(203)) + " alt></div> <div class=\"section2-toeic-intro-text\"><p>Khóa nền tảng cơ bản</p></div></div> <div class=\"section-content-row-fl section1-intro-content\"><div class=\"section1-intro-img\"><img" + _vm._ssrAttr("src", __webpack_require__(289)) + " alt></div> <div class=\"section2-toeic-intro-text\"><p>Khóa trung cấp TOEIC</p></div></div> <div class=\"section-content-row-fl section1-intro-content\"><div class=\"section1-intro-img\"><img" + _vm._ssrAttr("src", __webpack_require__(203)) + " alt></div> <div class=\"section2-toeic-intro-text\"><p>Khóa chuyên sâu Toeic</p></div></div></div></div></div> "), _c('OtherCourseSection')], 2);
};
var staticRenderFns = [];
