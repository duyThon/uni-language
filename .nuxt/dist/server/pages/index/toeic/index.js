...
var add = __webpack_require__(10).default
module.exports.__inject__ = function (context) {
  add("92788ca4", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_d1d95734_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(213);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_d1d95734_prod_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_d1d95734_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_d1d95734_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_d1d95734_prod_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = ___CSS_LOADER_GET_URL_IMPORT___(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "#storytelling-course-banner{align-items:flex-end;background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");margin-right:50p}.section2-toeic p{text-align:center}.section2-toeic-content{display:flex;justify-content:center}.section2-toeic-content img{height:130px;margin:20px 50px 0}.section2-toeic-intro-text{font-weight:600;margin:0 0 0 20px;max-width:250px;text-align:center}@media (max-width:46.1875em){.section2-toeic-content{flex-direction:column}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index/toeic/index.vue?vue&type=template&id=d1d95734&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div id=\"storytelling-course-banner\" class=\"banner\"><div class=\"banner-text\"><div class=\"banner-text-content\"><p>DÀNH CHO ĐỘ TUỔI: 6-8 TUỔI</p> <h1>KHÓA HỌC LUYỆN THI TOEIC</h1> <h2>TOEIC COURSE</h2> <h4 style=\"margin:5px 0\">THỜI GIAN ĐÀO TẠO: 3 THÁNG</h4></div> <div class=\"banner-border-bottom\"></div></div></div> "), _vm._ssrNode("<div class=\"section section1\">", "</div>", [_c('el-row', {
    ...
    staticClass: "section1-intro-text"
  }, [_c('p', [_vm._v("Khung chương trình giản lược, tập trung các kiến thức trọng điểm")])])])])], 1)], 1), _vm._ssrNode(" <div class=\"section section2-toeic\"><div class=\"section2-intro\"><h2 style=\"margin-top: 0; text-align: center\">\n              Giới thiệu về khóa học\n          </h2> <p>Tại Uni, đội ngũ giảng viên hội tụ cả ba yếu tố tâm huyết - trí tuệ và phong cách để có cách dạy vừa cuốn hút, vừa dễ hiểu, giúp học viên chinh phục mục tiêu của mình trong thời gian ngắn nhất</p> <div class=\"section2-toeic-content\"><div class=\"section-content-row-fl section1-intro-content\"><div class=\"section1-intro-img\"><img" + _vm._ssrAttr("src", __webpack_require__(212)) + " alt></div> <div class=\"section2-toeic-intro-text\"><p>Khóa nền tảng cơ bản</p></div></div> <div class=\"section-content-row-fl section1-intro-content\"><div class=\"section1-intro-img\"><img" + _vm._ssrAttr("src", __webpack_require__(297)) + " alt></div> <div class=\"section2-toeic-intro-text\"><p>Khóa trung cấp TOEIC</p></div></div> <div class=\"section-content-row-fl section1-intro-content\"><div class=\"section1-intro-img\"><img" + _vm._ssrAttr("src", __webpack_require__(212)) + " alt></div> <div class=\"section2-toeic-intro-text\"><p>Khóa chuyên sâu Toeic</p></div></div></div></div></div> "), _c('OtherCourseSection')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/index/toeic/index.vue?vue&type=template&id=d1d95734&
