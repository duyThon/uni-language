  ...
  <div class="login-uni">
    <div class="login">
      <div class="login-logo">
        <img style="width:100px" src="@/assets/logo/logo-uni-ngang-2.png" alt="">
      </div>
      <input v-model="loginForm.loginUsername" type="text" placeholder="Tên đăng nhập" />
      <input v-model="loginForm.loginPassword" type="password" placeholder="Mật khẩu" />
      <button @click="checkPass">Đăng nhập</button>
    </div>
  </div>
</template>
