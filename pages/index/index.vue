<template>
  <div>
    <div id="homepage-background" class="banner">
      <BannerForm />
    </div>
...
<script>
import BannerForm from "@/components/common/BannerForm.vue";
...
import ParentsComment from '~/components/common/ParentsComment.vue';
