          ...
          <el-row :gutter="20">
            ...
            <el-col :xs="24" :sm="24" :lg="5">
              <div class="most-viewed">
                <div v-if="this.mostViewedList.length > 2" class="most-viewed-heading">CÁC BÀI VIẾT XEM NHIỀU</div>
              ...
              <div class="most-viewed">
                <div v-if="this.randomList.length > 2" class="most-viewed-heading">CÁC BÀI VIẾT NGẪU NHIÊN</div>
                <div class="most-viewed-item">
